<template>
  ...
  <div class="plane">
    <div class="plane-container">
      <img class="plane-human" src="../assets/images/login_human.png" alt="" />
      <div class="plane-title">
        每日诗词
        <img
          class="plane-title-line"
  ...
  <div class="footer">网站备案/许可证号：<el-link href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank">粤ICP备20019717号-1</el-link></div>
</template>

<script lang="ts">
  import {
    ref, reactive, defineComponent, computed,
    onMounted, toRefs, unref,
  } from 'vue'
  ...
  import sky_bg from '../assets/images/sky.png';
  import earth_bg from '../assets/images/earth_bg.png';
  import cloud_bg from '../assets/images/cloud.png';
  ...
  export default defineComponent({
    setup() {
      ...
      const initSceneBg = () => {
        // new THREE.TextureLoader().load(sky_bg), (texture: any) => {
        ...
        var geometry = new THREE.BoxGeometry(width, height, depth); //立方体
        var imageLoader = new THREE.ImageLoader();
        // load方法回调函数，按照路径加载图片，返回一个html的元素img对象
        imageLoader.load(sky_bg, function(img: any) {
      ...
      const initTubeRoute = (route?: any, geometryWidth?: number, geometryHeigh?: number) => {
        ...
        const cloudTexture = textureLoader.load(cloud_bg)
